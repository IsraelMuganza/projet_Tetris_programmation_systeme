...
public class TableauJeu extends JPanel{
    ...
    /**
     * controle le tetromino latterallement
     *
    ...
    /**
     * mouvvement du haut vers le bas par unite
     */
    ...
    public synchronized void replace(Forme forme){
        boolean[][] shape = forme.getCurrentShape();
